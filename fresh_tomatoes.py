...
<head>
    <meta charset="utf-8">
    <title>Makk's Movie Picks`</title>
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand white" href="#">Makk's Movie Picks</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <h4 class="foot-logo">click on the movie poster to view its trailer</h4>
          </div>
      </div>
...
def open_movies_page(movies):
    ...
    output_file = open('makk movie picks.html', 'w')
